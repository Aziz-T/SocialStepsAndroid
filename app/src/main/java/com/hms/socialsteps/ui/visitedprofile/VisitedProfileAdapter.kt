...
class VisitedProfileAdapter constructor(private val clickListener: VisitedProfileOnClickListener, val userId: String) :
    RecyclerView.Adapter<VisitedProfileAdapter.VisitedProfileViewHolder>(),
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VisitedProfileViewHolder {
        itemBinding = CardFeedBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return VisitedProfileViewHolder(itemBinding, clickListener)
    }

    override fun onBindViewHolder(holder: VisitedProfileViewHolder, position: Int) {
    ...
    inner class VisitedProfileViewHolder(
        private val itemBinding: CardFeedBinding,
        private val clickListener: VisitedProfileOnClickListener
    ...
    interface VisitedProfileOnClickListener {
