...
class FeedAdapter constructor(private val clickListener: FeedOnClickListener, val userId: String) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FeedViewHolder {
        ...
        return FeedViewHolder(itemBinding, clickListener)
    }
    ...
    inner class FeedViewHolder(
        ...
        private val clickListener: FeedOnClickListener
